...
1. Click 'Sign In'
1. Create an account using your UCL email address e.g. firstname.surname.22@ucl.ac.uk.
1. You should see a Project titled something like '[your name] - NSCI0010_22_23'. If you don't, this might be because you didn't use the correct email address in step 3.
